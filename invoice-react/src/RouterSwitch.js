  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/paymentPage" element={<PaymentPage  setSwitchedPage={setSwitchedPage} name={contactName} number={contactNumber} setContactName={setContactName} setContactNumber={setContactNumber} nextContactCount={nextContactCount} />} />
      </Routes>
    </BrowserRouter>
  );
};
