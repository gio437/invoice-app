  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/invoice-app/paymentPage" element={<PaymentPage name={contactName} number={contactNumber} setContactName={setContactName} setContactNumber={setContactNumber} />} />
      </Routes>
    </BrowserRouter>
  );
};
